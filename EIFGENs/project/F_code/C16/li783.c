...
EIF_INTEGER_32 F486_2933 (EIF_REFERENCE Current)
{
	GTCX
	...
	if (*(EIF_BOOLEAN *)(Current+ _CHROFF_2_0_)) {
		RTLE;
		return (EIF_INTEGER_32) F466_2905(Current);
	} else {
...
EIF_BOOLEAN F486_2934 (EIF_REFERENCE Current)
{
	GTCX
	...
	if (*(EIF_BOOLEAN *)(Current+ _CHROFF_2_0_)) {
		RTLE;
		return (EIF_BOOLEAN) F466_2917(Current);
	} else {
		Result = '\01';
...
void F486_2935 (EIF_REFERENCE Current)
{
	GTCX
	EIF_REFERENCE tr1 = NULL;
	RTLD;
...
void F486_2936 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_REFERENCE F486_2937 (EIF_REFERENCE Current)
{
...
EIF_REFERENCE F486_2938 (EIF_REFERENCE Current)
{
