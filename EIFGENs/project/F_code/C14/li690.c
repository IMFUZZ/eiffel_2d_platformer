...
/* {LIST}.is_equal */
EIF_BOOLEAN F558_3130 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	...
	if ((EIF_BOOLEAN)(Current == arg1)) {
		...
		Result = '\0';
		tb1 = '\0';
		tb2 = F306_1979(RTCV(arg1));
		if ((EIF_BOOLEAN)(F306_1979(Current) == tb2)) {
		...
		if (tb1) {
			...
			Result = (EIF_BOOLEAN)(F646_4692(Current) == ti4_1);
		}
		tb1 = '\0';
		if (Result) {
			tb1 = (EIF_BOOLEAN) !F306_1979(Current);
		}
		if (tb1) {
			tb1 = '\0';
			tr1 = F646_4681(Current);
			loc1 = tr1;
			if (EIF_TEST(loc1)) {
				tr1 = F646_4681(RTCV(arg1));
				loc2 = tr1;
				tb1 = EIF_TEST(loc2);
			}
			if (tb1) {
...
/* {LIST}.after */
EIF_BOOLEAN F558_3131 (EIF_REFERENCE Current)
{
	GTCX
	EIF_INTEGER_32 ti4_1;
...
/* {LIST}.before */
EIF_BOOLEAN F558_3132 (EIF_REFERENCE Current)
{
	GTCX
	EIF_INTEGER_32 ti4_1;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
