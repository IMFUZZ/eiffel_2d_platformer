...
/* {LIST}.is_equal */
EIF_BOOLEAN F550_3130 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	...
	if ((EIF_BOOLEAN)(Current == arg1)) {
		...
		Result = '\0';
		tb1 = '\0';
		tb2 = F298_1979(RTCV(arg1));
		if ((EIF_BOOLEAN)(F298_1979(Current) == tb2)) {
		...
		tb1 = '\0';
		if (Result) {
			tb1 = (EIF_BOOLEAN) !F298_1979(Current);
		}
		if (tb1) {
			tb1 = '\0';
			...
			if (tb1) {
				...
				for (;;) {
					...
					if (*(EIF_BOOLEAN *)(Current + O1691[dtype-183])) {
						ti4_1 = *(EIF_INTEGER_32 *)(eif_optimize_return = 1, (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R1737[dtype-421])(Current));
						ti4_2 = *(EIF_INTEGER_32 *)(eif_optimize_return = 1, (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R1737[Dtype(arg1)-421])(RTCV(arg1)));
			...
			tb2 = '\0';
			tb3 = '\0';
			if (F298_1979(Current)) {
				tb4 = F298_1979(RTCV(arg1));
				tb3 = tb4;
			}
			if (tb3) {
...
/* {LIST}.after */
EIF_BOOLEAN F550_3131 (EIF_REFERENCE Current)
{
	GTCX
	EIF_INTEGER_32 ti4_1;
	EIF_INTEGER_32 ti4_2;
...
/* {LIST}.before */
EIF_BOOLEAN F550_3132 (EIF_REFERENCE Current)
{
	GTCX
	EIF_INTEGER_32 ti4_1;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
