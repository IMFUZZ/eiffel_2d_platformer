...
/* {LINEAR}.exhausted */
EIF_BOOLEAN F382_2048 (EIF_REFERENCE Current)
{
	GTCX
...
/* {LINEAR}.off */
EIF_BOOLEAN F382_2050 (EIF_REFERENCE Current)
{
	GTCX
	...
	if (!F300_1979(Current)) {
		Result = (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R1784[Dtype(Current)-421])(Current);
	}
	RTLE;
	return Result;
}
...
/* {LINEAR}.do_all */
void F382_2053 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	...
	for (;;) {
		...
		tb1 = *(EIF_BOOLEAN *)(eif_optimize_return = 1, (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R1768[dtype-421])(Current));
