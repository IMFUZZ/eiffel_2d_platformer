...
void F1_23 (EIF_REFERENCE Current)
{
	...
	if (EIF_TEST(loc3)) {
		(FUNCTION_CAST(void, (EIF_REFERENCE)) R3296[Dtype(loc3)-624])(RTCV(loc3));
	} else {
		...
		tr1 = F1_5(Current);
		tr1 = (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R3563[Dtype(tr1)-691])(RTCV(tr1));
...
#define Result RTOTRR
	...
	RTGC;
	RTOTP;
	tr1 = RTLNS(34, 34, _OBJSIZ_1_0_0_0_0_0_0_0_);
	Result = (EIF_REFERENCE) tr1;
	F35_140(RTCV(Result));
	RTOTE;
	RTLE;
