...
void F81_1256 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTGC;
	F81_1261(Current, ((EIF_INTEGER_32) 0L));
...
EIF_BOOLEAN F81_1258 (EIF_REFERENCE Current)
{
	GTCX
...
void F81_1261 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	RTLD;
...
void F81_1262 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_INTEGER_32 arg2)
{
	GTCX
	...
	RTGC;
	F81_1261(Current, arg2);
	loc1 = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
	loc4 = (FUNCTION_CAST(EIF_INTEGER_32, (EIF_REFERENCE)) R4400[Dtype(arg1)-816])(RTCV(arg1));
	loc7 = arg1;
	loc7 = RTRV(eif_non_attached_type(816),loc7);
	if (EIF_TEST(loc7)) {
		loc2 = *(EIF_REFERENCE *)(RTCV(loc7) + O4483[Dtype(loc7)-816]);
		for (;;) {
		...
		if (EIF_TEST(loc8)) {
			loc3 = *(EIF_REFERENCE *)(RTCV(loc8) + O4624[Dtype(loc8)-819]);
			for (;;) {
				if ((EIF_BOOLEAN) ((EIF_BOOLEAN)(loc1 == loc4) || (EIF_BOOLEAN) (*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_4_0_1_) >= ((EIF_INTEGER_32) 4L)))) break;
				if ((EIF_BOOLEAN) ((EIF_INTEGER_32) (loc1 + ((EIF_INTEGER_32) 1L)) < loc4)) {
					/* INLINED CODE (SPECIAL.item) */
...
void F81_1263 (EIF_REFERENCE Current, EIF_CHARACTER_8 arg1)
{
	GTCX
			...
			case 0L:
				if ((EIF_BOOLEAN) (((EIF_BOOLEAN) ((EIF_BOOLEAN)(arg1 == (EIF_CHARACTER_8) '0') && (EIF_BOOLEAN) ((EIF_BOOLEAN)(*(EIF_CHARACTER_8 *)(Current+ _CHROFF_2_0_) == (EIF_CHARACTER_8) 'x') || (EIF_BOOLEAN)(*(EIF_CHARACTER_8 *)(Current+ _CHROFF_2_0_) == (EIF_CHARACTER_8) 'X')))) || (EIF_BOOLEAN)(arg1 == (EIF_CHARACTER_8) '&'))) {
					...
					if ((EIF_BOOLEAN) ((EIF_BOOLEAN)(arg1 == (EIF_CHARACTER_8) '-') || (EIF_BOOLEAN)(arg1 == (EIF_CHARACTER_8) '+'))) {
						...
						tr1 = RTLNS(749, 749, _OBJSIZ_0_1_0_0_0_0_0_0_);
						*(EIF_CHARACTER_8 *)tr1 = arg1;
						
						tb1 = F748_5311(RTCV(tr1));
						if (tb1) {
				...
				if (tb1) {
					...
					*(EIF_NATURAL_64 *)(Current+ _I64OFF_2_4_0_3_0_0_1_) = (EIF_NATURAL_64) tu8_1;
					...
					if ((EIF_BOOLEAN)(*(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_4_0_0_) != ((EIF_INTEGER_32) 0L))) {
						tr1 = RTOUCR(30,F81_1279,(Current));
						tb1 = F79_1232(RTCV(tr1), *(EIF_NATURAL_64 *)(Current+ _I64OFF_2_4_0_3_0_0_1_), *(EIF_NATURAL_64 *)(Current+ _I64OFF_2_4_0_3_0_0_2_), *(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_4_0_0_), *(EIF_INTEGER_32 *)(Current+ _LNGOFF_2_4_0_2_));
						if (tb1) {
...
EIF_BOOLEAN F81_1266 (EIF_REFERENCE Current)
{
	GTCX
	EIF_INTEGER_32 ti4_1;
...
EIF_NATURAL_32 F81_1274 (EIF_REFERENCE Current)
{
	GTCX
	EIF_NATURAL_64 tu8_1;
	EIF_NATURAL_64 tu8_2;
...
static EIF_REFERENCE F81_1279_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
...
EIF_REFERENCE F81_1279 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(30,F81_1279_body,(Current));
}
