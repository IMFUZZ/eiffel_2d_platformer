...
static EIF_REFERENCE F44_8071_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
...
#define Result RTOTRR
	...
	RTOTP;
	{
		static EIF_TYPE_INDEX typarr0[] = {658,818,0xFFFF};
	...
	*((EIF_REFERENCE *)tr2+6) = (EIF_REFERENCE) tr3;
	RTAR(tr2,tr3);
	tr1 = (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) F659_2958)(tr2);
	Result = (EIF_REFERENCE) tr1;
	F184_1908(RTCV(Result));
	RTOTE;
	RTLE;
	RTEE;
	return Result;
...
EIF_REFERENCE F44_8071 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(47,F44_8071_body,(Current));
}

/* {DATE_TIME_TOOLS}.months_text */
static EIF_REFERENCE F44_8072_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE tr1 = NULL;
...
EIF_REFERENCE F44_8072 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(48,F44_8072_body,(Current));
}

/* {DATE_TIME_TOOLS}.date_default_format_string */

EIF_REFERENCE F44_8075 (EIF_REFERENCE Current)
{
	GTCX
	RTOUC (45,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}

/* {DATE_TIME_TOOLS}.time_default_format_string */

EIF_REFERENCE F44_8076 (EIF_REFERENCE Current)
{
	GTCX
	RTOUC (52,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}

/* {DATE_TIME_TOOLS}.default_format_string */

EIF_REFERENCE F44_8077 (EIF_REFERENCE Current)
{
	GTCX
	RTOUC (53,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}
