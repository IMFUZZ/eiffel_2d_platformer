...
/* {DATE_VALUE}.day */
EIF_INTEGER_32 F627_8662 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTGC;
	ti4_1 = *(EIF_INTEGER_32 *)(Current + O6466[Dtype(Current)-626]);
...
/* {DATE_VALUE}.month */
EIF_INTEGER_32 F627_8663 (EIF_REFERENCE Current)
{
	GTCX
	EIF_INTEGER_32 ti4_1;
	EIF_INTEGER_32 Result = ((EIF_INTEGER_32) 0);
...
/* {DATE_VALUE}.year */
EIF_INTEGER_32 F627_8664 (EIF_REFERENCE Current)
{
	GTCX
	EIF_INTEGER_32 ti4_1;
	EIF_INTEGER_32 Result = ((EIF_INTEGER_32) 0);
...
/* {DATE_VALUE}.set_date */
void F627_8667 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1, EIF_INTEGER_32 arg2, EIF_INTEGER_32 arg3)
{
	GTCX
	...
	loc1 = eif_bit_or(loc1,ti4_1);
	*(EIF_INTEGER_32 *)(Current + O6466[Dtype(Current)-626]) = (EIF_INTEGER_32) loc1;
	RTLE;
}

/* {DATE_VALUE}.correct_mismatch */
void F627_8673 (EIF_REFERENCE Current)
{
	GTCX
	...
	tr2 = RTOUCR(54,F627_8680,(Current));
	tr1 = F628_4528(RTCV(tr1), tr2);
	loc1 = RTCCL(tr1);
	loc1 = RTRV(eif_non_attached_type(768),loc1);
	if (EIF_TEST(loc1)) {
		ti4_1 = *(EIF_INTEGER_32 *)(RTCV(loc1)+ _LNGOFF_0_0_0_0_);
		F627_8681(Current, ti4_1);
	} else {
		F625_4457(Current);
	}
	RTLE;
...
EIF_REFERENCE F627_8680 (EIF_REFERENCE Current)
{
	GTCX
	RTOUC (54,RTMS_EX_H("compact_date",12,1114629989));
}

/* {DATE_VALUE}.set_private_internal_compact_date */
void F627_8681 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	EIF_INTEGER_32 ti4_1;
	...
	F627_8667(Current, ti4_1, ti4_2, ti4_3);
	RTLE;
}
