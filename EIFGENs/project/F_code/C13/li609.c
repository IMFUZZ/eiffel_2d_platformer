...
/* {LIST}.is_equal */
EIF_BOOLEAN F556_3130 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	...
	if ((EIF_BOOLEAN)(Current == arg1)) {
		...
		Result = '\0';
		tb1 = '\0';
		tb2 = F304_1979(RTCV(arg1));
		if ((EIF_BOOLEAN)(F304_1979(Current) == tb2)) {
		...
		if (tb1) {
			...
			Result = (EIF_BOOLEAN)(F644_4692(Current) == ti4_1);
		}
		tb1 = '\0';
		if (Result) {
			tb1 = (EIF_BOOLEAN) !F304_1979(Current);
		}
		if (tb1) {
			tb1 = '\0';
			tr1 = F644_4681(Current);
			loc1 = tr1;
			if (EIF_TEST(loc1)) {
				tr1 = F644_4681(RTCV(arg1));
				loc2 = tr1;
				tb1 = EIF_TEST(loc2);
			}
			if (tb1) {
				...
				for (;;) {
					tb1 = '\01';
					if (!F556_3131(Current)) {
						tb1 = (EIF_BOOLEAN) !Result;
					}
					if (tb1) break;
					if (*(EIF_BOOLEAN *)(Current + O1691[dtype-183])) {
						tu2_1 = F644_4675(Current);
						tu2_2 = F644_4675(RTCV(arg1));
				...
				F644_4706(RTCV(arg1), loc2);
			} else {
			}
		} else {
			tb2 = '\0';
			tb3 = '\0';
			if (F304_1979(Current)) {
				tb4 = F304_1979(RTCV(arg1));
				tb3 = tb4;
			}
			if (tb3) {
...
/* {LIST}.after */
EIF_BOOLEAN F556_3131 (EIF_REFERENCE Current)
{
	GTCX
	EIF_INTEGER_32 ti4_1;
...
/* {LIST}.before */
EIF_BOOLEAN F556_3132 (EIF_REFERENCE Current)
{
	GTCX
	EIF_INTEGER_32 ti4_1;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
