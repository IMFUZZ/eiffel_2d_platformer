...
void F472_2904 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	...
	RTGC;
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + O2384[Dtype(Current)-463]) = (EIF_REFERENCE) arg1;
	loc1 = arg1;
...
EIF_NATURAL_32 F472_2905 (EIF_REFERENCE Current)
{
	GTCX
	...
	Result = *(EIF_NATURAL_32 *)(eif_optimize_return = 1, (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE, EIF_INTEGER_32)) R2387[Dtype(tr1)-516])(RTCV(tr1), *(EIF_INTEGER_32 *)(Current+ _LNGOFF_1_1_0_1_)));
	RTLE;
	return Result;
}

/* {INDEXABLE_ITERATION_CURSOR}.after */
EIF_BOOLEAN F472_2917 (EIF_REFERENCE Current)
{
	GTCX
	EIF_REFERENCE tr1 = NULL;
	EIF_BOOLEAN tb1;
...
EIF_BOOLEAN F472_2919 (EIF_REFERENCE Current)
{
	GTCX
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	EIF_REFERENCE tr1 = NULL;
...
void F472_2924 (EIF_REFERENCE Current)
{
	GTCX
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
...
void F472_2925 (EIF_REFERENCE Current)
{
	GTCX
	RTLD;
...
EIF_REFERENCE F472_2926 (EIF_REFERENCE Current)
{
...
EIF_REFERENCE F472_2927 (EIF_REFERENCE Current)
{
	GTCX
	EIF_REFERENCE tr1 = NULL;
