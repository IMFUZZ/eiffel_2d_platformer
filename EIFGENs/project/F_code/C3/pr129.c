...
/* {PRIMES}.higher_prime */
EIF_INTEGER_32 F424_2303 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	...
	if ((EIF_BOOLEAN) (arg1 <= ((EIF_INTEGER_32) 2L))) {
		...
		for (;;) {
			if (F424_2306(Current, Result)) break;
...
EIF_REFERENCE F424_2305 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	...
	F603_3530(RTCV(tr1), (EIF_BOOLEAN) 0, ((EIF_INTEGER_32) 1L), arg1);
	Result = (EIF_REFERENCE) tr1;
	loc1 = (EIF_INTEGER_32) ((EIF_INTEGER_32) 3L);
	for (;;) {
		if ((EIF_BOOLEAN) (loc1 > arg1)) break;
		F603_3555(RTCV(Result), (EIF_BOOLEAN) 1, loc1);
		loc1 += ((EIF_INTEGER_32) 2L);
	}
	if ((EIF_BOOLEAN) (arg1 >= ((EIF_INTEGER_32) 2L))) {
		F603_3555(RTCV(Result), (EIF_BOOLEAN) 1, ((EIF_INTEGER_32) 2L));
	}
	loc1 = (EIF_INTEGER_32) ((EIF_INTEGER_32) 3L);
	for (;;) {
		if ((EIF_BOOLEAN) ((EIF_INTEGER_32) (loc1 * loc1) > arg1)) break;
		tb1 = F603_3535(RTCV(Result), loc1);
		if (tb1) {
			loc2 = (EIF_INTEGER_32) (EIF_INTEGER_32) (loc1 * loc1);
			for (;;) {
				if ((EIF_BOOLEAN) (loc2 > arg1)) break;
				F603_3555(RTCV(Result), (EIF_BOOLEAN) 0, loc2);
...
/* {PRIMES}.is_prime */
EIF_BOOLEAN F424_2306 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	EIF_INTEGER_32 loc1 = (EIF_INTEGER_32) 0;
...
/* {PRIMES}.i_th */
EIF_INTEGER_32 F424_2307 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	...
	RTGC;
	loc3 = RTOUCR(31,F424_2309,(Current));
	tb1 = '\0';
	...
	if (tb1) {
		ti4_1 = F601_3535(RTCV(loc3), arg1);
		RTLE;
		return (EIF_INTEGER_32) ti4_1;
	} else {
		ti4_1 = F424_2310(Current, arg1);
		loc1 = F424_2305(Current, ti4_1);
		Result = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
		loc2 = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
		for (;;) {
			if ((EIF_BOOLEAN)(loc2 == arg1)) break;
			Result++;
			tb1 = F603_3535(RTCV(loc1), Result);
			if (tb1) {
				loc2++;
			}
		}
...
static EIF_REFERENCE F424_2309_body (EIF_REFERENCE Current)
{
	GTCX
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
...
#define Result RTOTRR
	...
	RTGC;
	RTOTP;
	ti4_1 = F424_2310(Current, ((EIF_INTEGER_32) 200L));
	loc1 = F424_2305(Current, ti4_1);
	{
		static EIF_TYPE_INDEX typarr0[] = {600,770,0xFFFF};
		EIF_TYPE_INDEX typres0;
		static EIF_TYPE_INDEX typcache0 = INVALID_DTYPE;
	...
	F601_3530(RTCV(tr1), ((EIF_INTEGER_32) 0L), ((EIF_INTEGER_32) 1L), ((EIF_INTEGER_32) 200L));
	Result = (EIF_REFERENCE) tr1;
	loc3 = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
	loc2 = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
	for (;;) {
		if ((EIF_BOOLEAN) (loc3 > ((EIF_INTEGER_32) 200L))) break;
		tb1 = F603_3535(RTCV(loc1), loc2);
		if (tb1) {
			F601_3555(RTCV(Result), loc2, loc3);
			loc3++;
		}
		loc2++;
	}
...
EIF_REFERENCE F424_2309 (EIF_REFERENCE Current)
{
	GTCX
	return RTOUCR(31,F424_2309_body,(Current));
}

/* {PRIMES}.approximated_i_th */
EIF_INTEGER_32 F424_2310 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	...
	if ((EIF_BOOLEAN) (arg1 >= ((EIF_INTEGER_32) 13L))) {
		tr1 = RTLNS(128, 128, _OBJSIZ_0_0_0_0_0_0_0_0_);
