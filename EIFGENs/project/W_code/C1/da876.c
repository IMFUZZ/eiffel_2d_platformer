...
extern EIF_TYPED_VALUE F876_8070(EIF_REFERENCE);
extern EIF_TYPED_VALUE F876_8071(EIF_REFERENCE);
extern EIF_TYPED_VALUE F876_8072(EIF_REFERENCE);
extern EIF_TYPED_VALUE F876_8073(EIF_REFERENCE);
extern EIF_TYPED_VALUE F876_8074(EIF_REFERENCE);
extern EIF_TYPED_VALUE F876_8075(EIF_REFERENCE);
extern EIF_TYPED_VALUE F876_8076(EIF_REFERENCE);
extern EIF_TYPED_VALUE F876_8077(EIF_REFERENCE);
...
EIF_TYPED_VALUE F876_8070 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F876_8070,13631,RTMS_EX_H("English",7,257590376));
}

/* {DATE_TIME_TOOLS}.days_text */
RTOID (F876_8071)
EIF_TYPED_VALUE F876_8071 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 875, Current, 0, 0, 13631);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(875, Current, 13631);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {260,220,0xFFFF};
...
RTOID (F876_8072)
EIF_TYPED_VALUE F876_8072 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 875, Current, 0, 0, 13632);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(875, Current, 13632);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000F5, 0,0); /* Result */
...
RTOID (F876_8073)
EIF_TYPED_VALUE F876_8073 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 875, Current, 0, 0, 13633);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(875, Current, 13633);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000F5, 0,0); /* Result */
...
RTOID (F876_8074)
EIF_TYPED_VALUE F876_8074 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 875, Current, 0, 0, 13634);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(875, Current, 13634);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000F5, 0,0); /* Result */
...
EIF_TYPED_VALUE F876_8075 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F876_8075,13636,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
EIF_TYPED_VALUE F876_8076 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F876_8076,13637,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
EIF_TYPED_VALUE F876_8077 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F876_8077,13638,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit876 (void)
{
	GTCX
	RTOTS (8070,F876_8070)
	RTOTS (8071,F876_8071)
	RTOTS (8072,F876_8072)
	RTOTS (8073,F876_8073)
	RTOTS (8074,F876_8074)
	RTOTS (8075,F876_8075)
	RTOTS (8076,F876_8076)
	RTOTS (8077,F876_8077)
}
