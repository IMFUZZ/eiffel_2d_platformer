...
extern void F874_8057(EIF_REFERENCE);
extern void F874_8058(EIF_REFERENCE);
extern EIF_TYPED_VALUE F874_8059(EIF_REFERENCE);
extern void F874_8060(EIF_REFERENCE);
extern void F874_8061(EIF_REFERENCE);
...
void F874_8057 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 873, Current, 0, 0, 13627);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(873, Current, 13627);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
void F874_8058 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 873, Current, 2, 0, 13628);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(873, Current, 13628);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 1, 0x10000000, 1, 0); /* loc1 */
	
	loc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5920, 871))(Current)).it_i4);
	RTHOOK(2);
	if ((EIF_BOOLEAN)(loc1 != ((EIF_INTEGER_32) 0L))) {
		...
		tr1 = RTLN(125);
		tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5922, 871))(Current)).it_p);
		up1 = tp1;
	...
	if (RTAL & CK_ENSURE) {
		...
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5949, dtype))(Current)).it_b);
		if (tb1) {
			RTCK;
		} else {
			RTCF;
...
EIF_TYPED_VALUE F874_8059 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 873, Current, 0, 0, 13629);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(873, Current, 13629);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F874_8060 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 873, Current, 0, 0, 13625);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(873, Current, 13625);
	RTIV(Current, RTAL);
...
void F874_8061 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 873, Current, 1, 0, 13626);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(873, Current, 13626);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (tb1) {
		RTHOOK(4);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(5950, dtype))(Current);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(5);
