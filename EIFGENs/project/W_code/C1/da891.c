...
extern EIF_TYPED_VALUE F891_8231(EIF_REFERENCE);
extern EIF_TYPED_VALUE F891_8232(EIF_REFERENCE);
extern EIF_TYPED_VALUE F891_8233(EIF_REFERENCE);
...
EIF_TYPED_VALUE F891_8231 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F891_8232 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F891_8233 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 890, Current, 0, 0, 13772);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(890, Current, 13772);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	tr8_1 = *(EIF_REAL_64 *)(tr1 + RTVA(6063, "fractional_second", tr1));
