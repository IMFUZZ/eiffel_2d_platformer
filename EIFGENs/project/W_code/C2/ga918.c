...
extern void F918_8596(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F918_8597(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F918_8596 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 917, Current, 0, 1, 14125);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(917, Current, 14125);
	if (arg1) {
		RTCC(arg1, 917, l_feature_name, 1, 220);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
...
void F918_8597 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 917, Current, 3, 1, 14126);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(917, Current, 14126);
	if (arg1) {
		RTCC(arg1, 917, l_feature_name, 1, 220);
	}
	RTIV(Current, RTAL);
...
body:;
	...
	up1 = tp1;
	loc3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(4916, 860))(Current, up1x)).it_p);
	RTHOOK(4);
	tb1 = !loc3;
	if (tb1) {
		RTHOOK(5);
		...
		tr1 = RTLN(125);
		tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(4918, 860))(Current)).it_p);
		up1 = tp1;
