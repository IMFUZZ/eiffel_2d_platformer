...
extern void F915_8588(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F915_8588 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 914, Current, 1, 1, 14117);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(914, Current, 14117);
	if (arg1) {
		RTCC(arg1, 914, l_feature_name, 1, 220);
	}
	RTIV(Current, RTAL);
...
body:;
	...
	up1 = tp1;
	tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5251, 867))(Current, up1x)).it_p);
	up1 = tp1;
